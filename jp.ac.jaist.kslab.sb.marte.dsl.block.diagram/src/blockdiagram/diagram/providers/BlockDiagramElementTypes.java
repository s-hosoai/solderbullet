 ...
 * @generated
 */
public class BlockDiagramElementTypes {

	/**
	 * @generated
	 */
	private BlockDiagramElementTypes() {
	}
	 ...
	 * @generated
	 */
	public static final IElementType Diagram_1000 = getElementType("jp.ac.jaist.kslab.sb.marte.dsl.block.diagram.Diagram_1000"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Device_2001 = getElementType("jp.ac.jaist.kslab.sb.marte.dsl.block.diagram.Device_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType MCU_2002 = getElementType("jp.ac.jaist.kslab.sb.marte.dsl.block.diagram.MCU_2002"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Connection_4001 = getElementType("jp.ac.jaist.kslab.sb.marte.dsl.block.diagram.Connection_4001"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Diagram_1000,
					BlockdiagramPackage.eINSTANCE.getDiagram());

			elements.put(Device_2001, BlockdiagramPackage.eINSTANCE.getDevice());

			elements.put(MCU_2002, BlockdiagramPackage.eINSTANCE.getMCU());

			elements.put(Connection_4001,
					BlockdiagramPackage.eINSTANCE.getConnection());
		}
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(MCU_2002);
