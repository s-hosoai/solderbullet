package blockdiagram.diagram.providers;
 ...
 * @generated
 */
public class BlockDiagramViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = BlockDiagramVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = BlockDiagramVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!BlockDiagramElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != BlockDiagramVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!DiagramEditPart.MODEL_ID
						.equals(BlockDiagramVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return DeviceEditPart.VISUAL_ID == visualID
				|| MCUEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = BlockDiagramVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = BlockDiagramVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case DeviceEditPart.VISUAL_ID:
		...
		case MCUEditPart.VISUAL_ID:
			return createMCU_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (BlockDiagramVisualIDRegistry.getVisualID(elementTypeHint)) {
	...
	public Node createDevice_2001(EObject domainElement, View containerView,
		...
		node.setType(BlockDiagramVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createMCU_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(BlockDiagramVisualIDRegistry
				.getType(MCUEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5002 = createLabel(node,
				BlockDiagramVisualIDRegistry.getType(MCUNameEditPart.VISUAL_ID));
		return node;
	}
	...
	public Edge createConnection_4001(EObject domainElement,
		...
		edge.setType(BlockDiagramVisualIDRegistry
