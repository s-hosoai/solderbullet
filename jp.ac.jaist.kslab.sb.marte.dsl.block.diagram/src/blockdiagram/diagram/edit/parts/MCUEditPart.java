...
import blockdiagram.diagram.edit.policies.MCUItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MCUEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		return primaryShape = new MCUFigure();
	}

	/**
	 * @generated
	 */
	public MCUFigure getPrimaryShape() {
		return (MCUFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MCUNameEditPart) {
			((MCUNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureMCUNameFigure());
			return true;
		}
		return false;
	}
	...
	public List/*[org.eclipse.gmf.runtime.emf.type.core.IElementType]*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof blockdiagram.diagram.edit.parts.MCUEditPart) {
			types.add(BlockDiagramElementTypes.Connection_4001);
		}
		return types;
	}
	 ...
	 * @generated
	 */
	public class MCUFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureMCUNameFigure;
		...
		private void createContents() {
			...
			fFigureMCUNameFigure = new WrappingLabel();
			fFigureMCUNameFigure.setText("<...>");

			this.add(fFigureMCUNameFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureMCUNameFigure() {
			return fFigureMCUNameFigure;
		}
