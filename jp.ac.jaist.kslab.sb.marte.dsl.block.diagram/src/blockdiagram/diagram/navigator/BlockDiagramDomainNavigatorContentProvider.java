 ...
 * @generated
 */
public class BlockDiagramDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public BlockDiagramDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof BlockDiagramDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((BlockDiagramDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new BlockDiagramDomainNavigatorItem(
