...
/**
 * This is the item provider adapter for a {@link blockdiagram.Diagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramItemProvider
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BlockdiagramPackage.Literals.DIAGRAM__COM);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BlockdiagramPackage.Literals.DIAGRAM__COM,
				 BlockdiagramFactory.eINSTANCE.createHwComponent()));

		newChildDescriptors.add
			(createChildParameter
				(BlockdiagramPackage.Literals.DIAGRAM__COM,
				 BlockdiagramFactory.eINSTANCE.createMCU()));

		newChildDescriptors.add
			(createChildParameter
				(BlockdiagramPackage.Literals.DIAGRAM__COM,
				 BlockdiagramFactory.eINSTANCE.createDevice()));
	}
