...
/**
 * This is the item provider adapter for a {@link blockdiagram.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_ref_feature", "_UI_Connection_type"),
				 BlockdiagramPackage.Literals.CONNECTION__REF,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BlockdiagramPackage.Literals.CONNECTION__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Connection.class)) {
			case BlockdiagramPackage.CONNECTION__NAME:
