...
/**
 * This is the item provider adapter for a {@link MARTE_Library.MARTE_DataTypes.IntegerInterval} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerIntervalItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerInterval_bound_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerInterval_bound_feature", "_UI_IntegerInterval_type"),
				 MARTE_DataTypesPackage.Literals.INTEGER_INTERVAL__BOUND,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		return getString("_UI_IntegerInterval_type");
	}
