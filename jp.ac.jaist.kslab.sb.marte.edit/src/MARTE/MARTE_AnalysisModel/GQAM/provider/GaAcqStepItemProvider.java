...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_AnalysisModel.GQAM.GaAcqStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GaAcqStepItemProvider extends GaStepItemProvider {
	/**
	 ...
	 * @generated
	 */
	public GaAcqStepItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GaAcqStep_acqRes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GaAcqStep_acqRes_feature", "_UI_GaAcqStep_type"),
				 GQAMPackage.Literals.GA_ACQ_STEP__ACQ_RES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GQAMPackage.Literals.GA_ACQ_STEP__RES_UNITS);
		}
	...
	/**
	 * This returns GaAcqStep.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GaAcqStep"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_GaAcqStep_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GaAcqStep.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GQAMPackage.Literals.GA_ACQ_STEP__RES_UNITS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection selection) {
		...
		boolean qualify =
			...
			childFeature == GQAMPackage.Literals.GA_ACQ_STEP__RES_UNITS;
