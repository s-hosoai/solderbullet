...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_AnalysisModel.GQAM.GaRelStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GaRelStepItemProvider extends GaStepItemProvider {
	/**
	 ...
	 * @generated
	 */
	public GaRelStepItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GaRelStep_relRes_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GaRelStep_relRes_feature", "_UI_GaRelStep_type"),
				 GQAMPackage.Literals.GA_REL_STEP__REL_RES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GQAMPackage.Literals.GA_REL_STEP__RES_UNITS);
		}
	...
	/**
	 * This returns GaRelStep.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GaRelStep"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_GaRelStep_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GaRelStep.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GQAMPackage.Literals.GA_REL_STEP__RES_UNITS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection selection) {
		...
		boolean qualify =
			...
			childFeature == GQAMPackage.Literals.GA_REL_STEP__RES_UNITS;
