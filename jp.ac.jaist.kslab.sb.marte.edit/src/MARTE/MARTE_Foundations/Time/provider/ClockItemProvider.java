...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_Foundations.Time.Clock} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClockItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clock_standard_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clock_standard_feature", "_UI_Clock_type"),
				 TimePackage.Literals.CLOCK__STANDARD,
				 true,
				 false,
				 false,
	...
	protected void addBase_InstanceSpecificationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clock_base_InstanceSpecification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clock_base_InstanceSpecification_feature", "_UI_Clock_type"),
				 TimePackage.Literals.CLOCK__BASE_INSTANCE_SPECIFICATION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clock_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clock_type_feature", "_UI_Clock_type"),
				 TimePackage.Literals.CLOCK__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clock_unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clock_unit_feature", "_UI_Clock_type"),
				 TimePackage.Literals.CLOCK__UNIT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addBase_PropertyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clock_base_Property_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clock_base_Property_feature", "_UI_Clock_type"),
				 TimePackage.Literals.CLOCK__BASE_PROPERTY,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		TimeStandardKind labelValue = ((Clock)object).getStandard();
