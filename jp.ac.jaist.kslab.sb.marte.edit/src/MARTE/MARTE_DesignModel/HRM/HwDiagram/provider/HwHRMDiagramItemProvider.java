...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwDiagram.HwHRMDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwHRMDiagramItemProvider 
	 ...
	 * @generated
	 */
	public HwHRMDiagramItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HwHRMDiagram_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HwHRMDiagram_name_feature", "_UI_HwHRMDiagram_type"),
				 HwDiagramPackage.Literals.HW_HRM_DIAGRAM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HwDiagramPackage.Literals.HW_HRM_DIAGRAM__COMPONENTS);
			childrenFeatures.add(HwDiagramPackage.Literals.HW_HRM_DIAGRAM__CONNECTIONS);
			childrenFeatures.add(HwDiagramPackage.Literals.HW_HRM_DIAGRAM__PROTOCOLS);
			childrenFeatures.add(HwDiagramPackage.Literals.HW_HRM_DIAGRAM__DATATYPES);
		}
	...
	/**
	 * This returns HwHRMDiagram.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HwHRMDiagram"));
	}
	...
	public String getText(Object object) {
		String label = ((HwHRMDiagram)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HwHRMDiagram_type") :
			getString("_UI_HwHRMDiagram_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HwHRMDiagram.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HwDiagramPackage.Literals.HW_HRM_DIAGRAM__COMPONENTS,
		...
		newChildDescriptors.add
			(createChildParameter
				(HwDiagramPackage.Literals.HW_HRM_DIAGRAM__CONNECTIONS,
				 HwCommunicationFactory.eINSTANCE.createHwMedia()));
		...
		newChildDescriptors.add
			(createChildParameter
				(HwDiagramPackage.Literals.HW_HRM_DIAGRAM__PROTOCOLS,
				 HwProtocolFactory.eINSTANCE.createHwProtocol()));

		newChildDescriptors.add
			(createChildParameter
				(HwDiagramPackage.Literals.HW_HRM_DIAGRAM__DATATYPES,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection selection) {
		...
		boolean qualify =
			childFeature == HwDiagramPackage.Literals.HW_HRM_DIAGRAM__COMPONENTS ||
			childFeature == HwDiagramPackage.Literals.HW_HRM_DIAGRAM__CONNECTIONS;
