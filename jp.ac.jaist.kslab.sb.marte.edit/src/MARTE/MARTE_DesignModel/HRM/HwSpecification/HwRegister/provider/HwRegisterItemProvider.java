/**
 */
package MARTE.MARTE_DesignModel.HRM.HwSpecification.HwRegister.provider;
...
import MARTE.MARTE_DesignModel.HRM.HwLogical.HwStorage.HwMemory.provider.HwMemoryItemProvider;
...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwSpecification.HwRegister.HwRegister} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwRegisterItemProvider extends HwMemoryItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HwRegisterItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HwRegister_address_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HwRegister_address_feature", "_UI_HwRegister_type"),
				 HwRegisterPackage.Literals.HW_REGISTER__ADDRESS,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns HwRegister.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HwRegister"));
	}
	...
	public String getText(Object object) {
		String label = ((HwRegister)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HwRegister_type") :
			getString("_UI_HwRegister_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HwRegister.class)) {
			case HwRegisterPackage.HW_REGISTER__ADDRESS:
