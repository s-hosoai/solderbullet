/**
 */
package MARTE.MARTE_DesignModel.HRM.HwGeneral.provider;
...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwGeneral.HwResource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwResourceItemProvider extends ResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HwResourceItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns HwResource.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HwResource"));
	}
	...
	public String getText(Object object) {
		String label = ((HwResource)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HwResource_type") :
			getString("_UI_HwResource_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HwResource.class)) {
