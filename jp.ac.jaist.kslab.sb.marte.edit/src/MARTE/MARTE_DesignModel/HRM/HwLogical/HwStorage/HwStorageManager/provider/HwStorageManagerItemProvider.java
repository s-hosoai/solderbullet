...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwLogical.HwStorage.HwStorageManager.HwStorageManager} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwStorageManagerItemProvider extends HwResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HwStorageManagerItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HwStorageManager_managedMemories_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HwStorageManager_managedMemories_feature", "_UI_HwStorageManager_type"),
				 HwStorageManagerPackage.Literals.HW_STORAGE_MANAGER__MANAGED_MEMORIES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns HwStorageManager.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HwStorageManager"));
	}
	...
	public String getText(Object object) {
		String label = ((HwStorageManager)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HwStorageManager_type") :
			getString("_UI_HwStorageManager_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HwStorageManager.class)) {
