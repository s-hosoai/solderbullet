...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwLogical.HwStorage.HwMemory.Timing} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimingItemProvider 
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HwMemoryPackage.Literals.TIMING__NOTATION);
			childrenFeatures.add(HwMemoryPackage.Literals.TIMING__DESCRIPTION);
			childrenFeatures.add(HwMemoryPackage.Literals.TIMING__VALUE);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Timing_type");
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HwMemoryPackage.Literals.TIMING__NOTATION,
				 BasicNFP_TypesFactory.eINSTANCE.createNFP_String()));

		newChildDescriptors.add
			(createChildParameter
				(HwMemoryPackage.Literals.TIMING__DESCRIPTION,
				 BasicNFP_TypesFactory.eINSTANCE.createNFP_String()));

		newChildDescriptors.add
			(createChildParameter
				(HwMemoryPackage.Literals.TIMING__VALUE,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection selection) {
		...
		boolean qualify =
			childFeature == HwMemoryPackage.Literals.TIMING__NOTATION ||
			childFeature == HwMemoryPackage.Literals.TIMING__DESCRIPTION ||
			childFeature == HwMemoryPackage.Literals.TIMING__VALUE;
