...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwLogical.HwStorage.HwMemory.HwDrive} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwDriveItemProvider extends HwMemoryItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HwDriveItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HwMemoryPackage.Literals.HW_DRIVE__SECTOR_SIZE);
			childrenFeatures.add(HwMemoryPackage.Literals.HW_DRIVE__BUFFER);
		}
	...
	/**
	 * This returns HwDrive.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HwDrive"));
	}
	...
	public String getText(Object object) {
		String label = ((HwDrive)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HwDrive_type") :
			getString("_UI_HwDrive_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HwDrive.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HwMemoryPackage.Literals.HW_DRIVE__SECTOR_SIZE,
				 BasicNFP_TypesFactory.eINSTANCE.createNFP_DataSize()));

		newChildDescriptors.add
			(createChildParameter
				(HwMemoryPackage.Literals.HW_DRIVE__BUFFER,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection selection) {
		...
		boolean qualify =
			...
			childFeature == HwMemoryPackage.Literals.HW_DRIVE__BUFFER ||
			...
			childFeature == HwMemoryPackage.Literals.HW_DRIVE__SECTOR_SIZE ||
