...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwLogical.HwStorage.HwMemory.HwRAM} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwRAMItemProvider extends HwMemoryItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HwRAMItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HwRAM_repl_Policy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HwRAM_repl_Policy_feature", "_UI_HwRAM_type"),
				 HwMemoryPackage.Literals.HW_RAM__REPL_POLICY,
				 true,
				 false,
				 false,
	...
	protected void addWritePolicyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HwRAM_writePolicy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HwRAM_writePolicy_feature", "_UI_HwRAM_type"),
				 HwMemoryPackage.Literals.HW_RAM__WRITE_POLICY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HwMemoryPackage.Literals.HW_RAM__ORGANIZATION);
			childrenFeatures.add(HwMemoryPackage.Literals.HW_RAM__IS_SYNCHRONOUS);
			childrenFeatures.add(HwMemoryPackage.Literals.HW_RAM__IS_STATIC);
			childrenFeatures.add(HwMemoryPackage.Literals.HW_RAM__IS_NON_VOLATILE);
		}
	...
	/**
	 * This returns HwRAM.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HwRAM"));
	}
	...
	public String getText(Object object) {
		String label = ((HwRAM)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HwRAM_type") :
			getString("_UI_HwRAM_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HwRAM.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HwMemoryPackage.Literals.HW_RAM__ORGANIZATION,
				 HwMemoryFactory.eINSTANCE.createMemoryOrganization()));

		newChildDescriptors.add
			(createChildParameter
				(HwMemoryPackage.Literals.HW_RAM__IS_SYNCHRONOUS,
				 BasicNFP_TypesFactory.eINSTANCE.createNFP_Boolean()));

		newChildDescriptors.add
			(createChildParameter
				(HwMemoryPackage.Literals.HW_RAM__IS_STATIC,
				 BasicNFP_TypesFactory.eINSTANCE.createNFP_Boolean()));

		newChildDescriptors.add
			(createChildParameter
				(HwMemoryPackage.Literals.HW_RAM__IS_NON_VOLATILE,
				 BasicNFP_TypesFactory.eINSTANCE.createNFP_Boolean()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection selection) {
		...
		boolean qualify =
			...
			childFeature == HwMemoryPackage.Literals.HW_RAM__IS_SYNCHRONOUS ||
			childFeature == HwMemoryPackage.Literals.HW_RAM__IS_STATIC ||
			childFeature == HwMemoryPackage.Literals.HW_RAM__IS_NON_VOLATILE;
