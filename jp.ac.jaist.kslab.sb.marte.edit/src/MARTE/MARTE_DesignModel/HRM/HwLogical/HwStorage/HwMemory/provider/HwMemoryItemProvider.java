...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwLogical.HwStorage.HwMemory.HwMemory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwMemoryItemProvider extends HwResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HwMemoryItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GRMPackage.Literals.STORAGE_RESOURCE__ELEMENT_SIZE);
			childrenFeatures.add(HwMemoryPackage.Literals.HW_MEMORY__MEMORY_SIZE);
			childrenFeatures.add(HwMemoryPackage.Literals.HW_MEMORY__ADRESS_SIZE);
			childrenFeatures.add(HwMemoryPackage.Literals.HW_MEMORY__TIMINGS);
			childrenFeatures.add(HwMemoryPackage.Literals.HW_MEMORY__THROUGHPUT);
		}
	...
	/**
	 * This returns HwMemory.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HwMemory"));
	}
	...
	public String getText(Object object) {
		String label = ((HwMemory)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HwMemory_type") :
			getString("_UI_HwMemory_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HwMemory.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GRMPackage.Literals.STORAGE_RESOURCE__ELEMENT_SIZE,
				 BasicNFP_TypesFactory.eINSTANCE.createNFP_Integer()));

		newChildDescriptors.add
			(createChildParameter
				(HwMemoryPackage.Literals.HW_MEMORY__MEMORY_SIZE,
				 BasicNFP_TypesFactory.eINSTANCE.createNFP_DataSize()));

		newChildDescriptors.add
			(createChildParameter
				(HwMemoryPackage.Literals.HW_MEMORY__ADRESS_SIZE,
				 BasicNFP_TypesFactory.eINSTANCE.createNFP_DataSize()));

		newChildDescriptors.add
			(createChildParameter
				(HwMemoryPackage.Literals.HW_MEMORY__TIMINGS,
				 HwMemoryFactory.eINSTANCE.createTiming()));

		newChildDescriptors.add
			(createChildParameter
				(HwMemoryPackage.Literals.HW_MEMORY__THROUGHPUT,
