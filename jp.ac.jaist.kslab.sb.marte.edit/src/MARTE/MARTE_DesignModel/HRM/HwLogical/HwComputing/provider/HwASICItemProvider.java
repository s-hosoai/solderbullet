...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwLogical.HwComputing.HwASIC} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwASICItemProvider extends HwComputingResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HwASICItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns HwASIC.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HwASIC"));
	}
	...
	public String getText(Object object) {
		String label = ((HwASIC)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HwASIC_type") :
			getString("_UI_HwASIC_type") + " " + label;
	}
