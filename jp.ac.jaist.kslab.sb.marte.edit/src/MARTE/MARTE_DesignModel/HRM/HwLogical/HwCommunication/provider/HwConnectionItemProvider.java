...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwLogical.HwCommunication.HwConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwConnectionItemProvider extends HwMediaItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HwConnection_protocols_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HwConnection_protocols_feature", "_UI_HwConnection_type"),
				 HwCommunicationPackage.Literals.HW_CONNECTION__PROTOCOLS,
				 true,
				 false,
				 true,
				 null,
