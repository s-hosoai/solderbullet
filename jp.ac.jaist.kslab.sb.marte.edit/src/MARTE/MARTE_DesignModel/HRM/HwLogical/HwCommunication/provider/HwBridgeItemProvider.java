...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwLogical.HwCommunication.HwBridge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwBridgeItemProvider extends HwMediaItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HwBridgeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HwBridge_sides_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HwBridge_sides_feature", "_UI_HwBridge_type"),
				 HwCommunicationPackage.Literals.HW_BRIDGE__SIDES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns HwBridge.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HwBridge"));
	}
	...
	public String getText(Object object) {
		String label = ((HwBridge)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HwBridge_type") :
			getString("_UI_HwBridge_type") + " " + label;
	}
