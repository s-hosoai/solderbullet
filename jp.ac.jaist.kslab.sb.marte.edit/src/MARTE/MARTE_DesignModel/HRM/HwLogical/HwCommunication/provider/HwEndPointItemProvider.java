...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwLogical.HwCommunication.HwEndPoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwEndPointItemProvider extends HwCommunicationResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HwEndPointItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HwEndPoint_connectedTo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HwEndPoint_connectedTo_feature", "_UI_HwEndPoint_type"),
				 HwCommunicationPackage.Literals.HW_END_POINT__CONNECTED_TO,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GRMPackage.Literals.COMMUNICATION_END_POINT__PACKET_SIZE);
		}
	...
	/**
	 * This returns HwEndPoint.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HwEndPoint"));
	}
	...
	public String getText(Object object) {
		String label = ((HwEndPoint)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HwEndPoint_type") :
			getString("_UI_HwEndPoint_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HwEndPoint.class)) {
