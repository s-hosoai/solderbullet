...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwLogical.HwDevice.HwI_O} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwI_OItemProvider extends HwDeviceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HwI_OItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns HwI_O.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HwI_O"));
	}
	...
	public String getText(Object object) {
		String label = ((HwI_O)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HwI_O_type") :
			getString("_UI_HwI_O_type") + " " + label;
	}
