...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwLogical.HwDevice.HWSensor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HWSensorItemProvider extends HwI_OItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HWSensorItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns HWSensor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HWSensor"));
	}
	...
	public String getText(Object object) {
		String label = ((HWSensor)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HWSensor_type") :
			getString("_UI_HWSensor_type") + " " + label;
	}
