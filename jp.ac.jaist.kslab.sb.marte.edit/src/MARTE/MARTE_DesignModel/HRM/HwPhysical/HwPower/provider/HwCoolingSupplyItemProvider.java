...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.HRM.HwPhysical.HwPower.HwCoolingSupply} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwCoolingSupplyItemProvider extends HwComponentItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HwCoolingSupplyItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HwPowerPackage.Literals.HW_COOLING_SUPPLY__COOLING_POWER);
		}
	...
	/**
	 * This returns HwCoolingSupply.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HwCoolingSupply"));
	}
	...
	public String getText(Object object) {
		String label = ((HwCoolingSupply)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HwCoolingSupply_type") :
			getString("_UI_HwCoolingSupply_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HwCoolingSupply.class)) {
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HwPowerPackage.Literals.HW_COOLING_SUPPLY__COOLING_POWER,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection selection) {
		...
		boolean qualify =
			...
			childFeature == HwPowerPackage.Literals.HW_COOLING_SUPPLY__COOLING_POWER ||
