...
/**
 * This is the item provider adapter for a {@link MARTE.MARTE_DesignModel.GCM.FlowProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GCMPackage.Literals.FLOW_PROPERTY__DIRECTION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GCMPackage.Literals.FLOW_PROPERTY__BASE_PROPERTY,
				 true,
				 false,
				 true,
				 null,
