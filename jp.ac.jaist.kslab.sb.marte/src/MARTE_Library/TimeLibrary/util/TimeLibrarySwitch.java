...
public class TimeLibrarySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TimeLibraryPackage.TIMED_VALUE_TYPE: {
				TimedValueType timedValueType = (TimedValueType)theEObject;
				T result = caseTimedValueType(timedValueType);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Timed Value Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Timed Value Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTimedValueType(TimedValueType object) {
		return null;
	}
