/**
 */
package MARTE_Library.TimeLibrary.util;
...
public class TimeLibraryAdapterFactory extends AdapterFactoryImpl {
	...
	protected TimeLibrarySwitch<Adapter> modelSwitch =
		new TimeLibrarySwitch<Adapter>() {
			@Override
			public Adapter caseTimedValueType(TimedValueType object) {
				return createTimedValueTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link MARTE_Library.TimeLibrary.TimedValueType <em>Timed Value Type</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTimedValueTypeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link MARTE_Library.TimeLibrary.IdealClock <em>Ideal Clock</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
