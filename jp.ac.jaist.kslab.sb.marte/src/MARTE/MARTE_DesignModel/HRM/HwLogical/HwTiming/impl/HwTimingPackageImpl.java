...
import MARTE.MARTE_DesignModel.HRM.HwLogical.HwTiming.HwTimingResource;
...
public class HwTimingPackageImpl extends EPackageImpl implements HwTimingPackage {
	 ...
	 * @see MARTE.MARTE_DesignModel.HRM.HwLogical.HwTiming.HwTimingPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getHwTimer_NbCounters() {
		return (EReference)hwTimerEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getHwTimer_CounterWidth() {
		return (EReference)hwTimerEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(hwTimerEClass, HW_TIMER__NB_COUNTERS);
		createEReference(hwTimerEClass, HW_TIMER__COUNTER_WIDTH);
	...
	public void initializePackageContents() {
		...
		initEReference(getHwTimer_NbCounters(), theBasicNFP_TypesPackage.getNFP_Natural(), null, "nbCounters", null, 0, 1, HwTimer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwTimer_CounterWidth(), theBasicNFP_TypesPackage.getNFP_DataSize(), null, "counterWidth", null, 0, 1, HwTimer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
