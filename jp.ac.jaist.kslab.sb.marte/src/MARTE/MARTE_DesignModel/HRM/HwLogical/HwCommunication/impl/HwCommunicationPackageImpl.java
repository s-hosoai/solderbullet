...
public class HwCommunicationPackageImpl extends EPackageImpl implements HwCommunicationPackage {
	 ...
	 * @see MARTE.MARTE_DesignModel.HRM.HwLogical.HwCommunication.HwCommunicationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getHwMedia_BandWidth() {
		return (EReference)hwMediaEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getHwBus_AdressWidth() {
		return (EReference)hwBusEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getHwBus_WordWidth() {
		return (EReference)hwBusEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getHwBus_IsSynchronous() {
		return (EReference)hwBusEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getHwBus_IsSerial() {
		return (EReference)hwBusEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getHwConnection_Protocols() {
	...
	public void createPackageContents() {
		...
		createEReference(hwMediaEClass, HW_MEDIA__BAND_WIDTH);
		createEReference(hwMediaEClass, HW_MEDIA__ARBITERS);

		hwBusEClass = createEClass(HW_BUS);
		createEReference(hwBusEClass, HW_BUS__ADRESS_WIDTH);
		createEReference(hwBusEClass, HW_BUS__WORD_WIDTH);
		createEReference(hwBusEClass, HW_BUS__IS_SYNCHRONOUS);
		createEReference(hwBusEClass, HW_BUS__IS_SERIAL);
		...
		createEReference(hwConnectionEClass, HW_CONNECTION__PROTOCOLS);
	}
	...
	public void initializePackageContents() {
		...
		hwPortEClass.getESuperTypes().add(this.getHwEndPoint());
		hwConnectionEClass.getESuperTypes().add(this.getHwMedia());
		...
		initEReference(getHwMedia_BandWidth(), theBasicNFP_TypesPackage.getNFP_DataTxRate(), null, "bandWidth", null, 0, 1, HwMedia.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getHwBus_AdressWidth(), theBasicNFP_TypesPackage.getNFP_DataSize(), null, "adressWidth", null, 0, 1, HwBus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwBus_WordWidth(), theBasicNFP_TypesPackage.getNFP_DataSize(), null, "wordWidth", null, 0, 1, HwBus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwBus_IsSynchronous(), theBasicNFP_TypesPackage.getNFP_Boolean(), null, "isSynchronous", null, 0, 1, HwBus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwBus_IsSerial(), theBasicNFP_TypesPackage.getNFP_Boolean(), null, "isSerial", null, 0, 1, HwBus.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getHwPort_Pins(), theHwIOPackage.getHwPin(), null, "pins", null, 0, -1, HwPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(hwConnectionEClass, HwConnection.class, "HwConnection", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getHwConnection_Protocols(), theHwProtocolPackage.getHwProtocol(), null, "protocols", null, 0, -1, HwConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
