...
public class HwStorageManagerPackageImpl extends EPackageImpl implements HwStorageManagerPackage {
	 ...
	 * @see MARTE.MARTE_DesignModel.HRM.HwLogical.HwStorage.HwStorageManager.HwStorageManagerPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getHwDMA_NbChannels() {
		return (EReference)hwDMAEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getHwDMA_TransferWidth() {
		return (EReference)hwDMAEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getHwMMU_VirtualAddrSpace() {
		return (EReference)hwMMUEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getHwMMU_PhysicalAddrSpace() {
		return (EReference)hwMMUEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getHwMMU_MemoryProtection() {
		return (EReference)hwMMUEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getHwMMU_NbEntries() {
		return (EReference)hwMMUEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(hwDMAEClass, HW_DMA__NB_CHANNELS);
		createEReference(hwDMAEClass, HW_DMA__TRANSFER_WIDTH);
		createEReference(hwDMAEClass, HW_DMA__DRIVEN_BY);

		hwMMUEClass = createEClass(HW_MMU);
		createEReference(hwMMUEClass, HW_MMU__VIRTUAL_ADDR_SPACE);
		createEReference(hwMMUEClass, HW_MMU__PHYSICAL_ADDR_SPACE);
		createEReference(hwMMUEClass, HW_MMU__MEMORY_PROTECTION);
		createEReference(hwMMUEClass, HW_MMU__NB_ENTRIES);
	...
	public void initializePackageContents() {
		...
		initEReference(getHwDMA_NbChannels(), theBasicNFP_TypesPackage.getNFP_Natural(), null, "nbChannels", null, 0, 1, HwDMA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwDMA_TransferWidth(), theBasicNFP_TypesPackage.getNFP_DataSize(), null, "transferWidth", null, 0, 1, HwDMA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getHwMMU_VirtualAddrSpace(), theBasicNFP_TypesPackage.getNFP_DataSize(), null, "virtualAddrSpace", null, 0, 1, HwMMU.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwMMU_PhysicalAddrSpace(), theBasicNFP_TypesPackage.getNFP_DataSize(), null, "physicalAddrSpace", null, 0, 1, HwMMU.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwMMU_MemoryProtection(), theBasicNFP_TypesPackage.getNFP_Boolean(), null, "memoryProtection", null, 0, 1, HwMMU.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwMMU_NbEntries(), theBasicNFP_TypesPackage.getNFP_Natural(), null, "nbEntries", null, 0, 1, HwMMU.class, !IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
