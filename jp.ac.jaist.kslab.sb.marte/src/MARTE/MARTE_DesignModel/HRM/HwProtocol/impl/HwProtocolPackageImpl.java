 ...
 * @generated
 */
public class HwProtocolPackageImpl extends EPackageImpl implements HwProtocolPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass hwProtocolEClass = null;
	 ...
	 * @see MARTE.MARTE_DesignModel.HRM.HwProtocol.HwProtocolPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private HwProtocolPackageImpl() {
		super(eNS_URI, HwProtocolFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link HwProtocolPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static HwProtocolPackage init() {
		if (isInited) return (HwProtocolPackage)EPackage.Registry.INSTANCE.getEPackage(HwProtocolPackage.eNS_URI);

		// Obtain or create and register package
		HwProtocolPackageImpl theHwProtocolPackage = (HwProtocolPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof HwProtocolPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new HwProtocolPackageImpl());
		...
		theHwProtocolPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(HwProtocolPackage.eNS_URI, theHwProtocolPackage);
		return theHwProtocolPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getHwProtocol() {
		return hwProtocolEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getHwProtocol_Operations() {
		return (EReference)hwProtocolEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getHwProtocol_Name() {
		return (EAttribute)hwProtocolEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public HwProtocolFactory getHwProtocolFactory() {
		return (HwProtocolFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		hwProtocolEClass = createEClass(HW_PROTOCOL);
		createEReference(hwProtocolEClass, HW_PROTOCOL__OPERATIONS);
		createEAttribute(hwProtocolEClass, HW_PROTOCOL__NAME);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(hwProtocolEClass, HwProtocol.class, "HwProtocol", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getHwProtocol_Operations(), theUMLPackage.getOperation(), null, "operations", null, 0, -1, HwProtocol.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHwProtocol_Name(), theEcorePackage.getEString(), "name", null, 0, 1, HwProtocol.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Create resource
		createResource(eNS_URI);
	}

} //HwProtocolPackageImpl
