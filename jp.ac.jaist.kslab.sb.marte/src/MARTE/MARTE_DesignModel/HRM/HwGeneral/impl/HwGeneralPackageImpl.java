...
public class HwGeneralPackageImpl extends EPackageImpl implements HwGeneralPackage {
	 ...
	 * @see MARTE.MARTE_DesignModel.HRM.HwGeneral.HwGeneralPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getHwResourceService_Consumption() {
		return (EReference)hwResourceServiceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getHwResourceService_Dissipation() {
		return (EReference)hwResourceServiceEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getHwResource_Description() {
		return (EReference)hwResourceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getHwResource_Frequency() {
		return (EReference)hwResourceEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getHwResource_Operations() {
		return (EReference)hwResourceEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EReference getHwResource_Activities() {
		return (EReference)hwResourceEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EAttribute getHwResource_Name() {
		return (EAttribute)hwResourceEClass.getEStructuralFeatures().get(8);
	}
	...
	public void createPackageContents() {
		...
		createEReference(hwResourceServiceEClass, HW_RESOURCE_SERVICE__CONSUMPTION);
		createEReference(hwResourceServiceEClass, HW_RESOURCE_SERVICE__DISSIPATION);

		hwResourceEClass = createEClass(HW_RESOURCE);
		createEReference(hwResourceEClass, HW_RESOURCE__DESCRIPTION);
		...
		createEReference(hwResourceEClass, HW_RESOURCE__FREQUENCY);
		createEReference(hwResourceEClass, HW_RESOURCE__OPERATIONS);
		createEReference(hwResourceEClass, HW_RESOURCE__ACTIVITIES);
		createEAttribute(hwResourceEClass, HW_RESOURCE__NAME);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getHwResourceService_Consumption(), theBasicNFP_TypesPackage.getNFP_Power(), null, "consumption", null, 0, 1, HwResourceService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwResourceService_Dissipation(), theBasicNFP_TypesPackage.getNFP_Power(), null, "dissipation", null, 0, 1, HwResourceService.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		initEClass(hwResourceEClass, HwResource.class, "HwResource", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getHwResource_Description(), theBasicNFP_TypesPackage.getNFP_String(), null, "description", null, 0, 1, HwResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getHwResource_Frequency(), theBasicNFP_TypesPackage.getNFP_Frequency(), null, "frequency", null, 0, 1, HwResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwResource_Operations(), theUMLPackage.getOperation(), null, "operations", null, 0, -1, HwResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHwResource_Activities(), theUMLPackage.getActivity(), null, "activities", null, 0, -1, HwResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHwResource_Name(), theEcorePackage.getEString(), "name", null, 0, 1, HwResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
