 ...
 * @generated
 */
public class HwDeviceFunctionSwitch {
	/**
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HwDeviceFunctionPackage.HW_DEVICE_FUNCTION: {
				HwDeviceFunction hwDeviceFunction = (HwDeviceFunction)theEObject;
				Object result = caseHwDeviceFunction(hwDeviceFunction);
				if (result == null) result = caseOperation(hwDeviceFunction);
				if (result == null) result = caseBehavioralFeature(hwDeviceFunction);
				if (result == null) result = caseParameterableElement(hwDeviceFunction);
				if (result == null) result = caseTemplateableElement(hwDeviceFunction);
				if (result == null) result = caseNamespace(hwDeviceFunction);
				if (result == null) result = caseFeature(hwDeviceFunction);
				if (result == null) result = caseRedefinableElement(hwDeviceFunction);
				if (result == null) result = caseNamedElement(hwDeviceFunction);
				if (result == null) result = caseElement(hwDeviceFunction);
				if (result == null) result = caseEModelElement(hwDeviceFunction);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Hw Device Function</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Hw Device Function</em>'.
