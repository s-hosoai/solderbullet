 ...
 * @generated
 */
public class HwDeviceFunctionPackageImpl extends EPackageImpl implements HwDeviceFunctionPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass hwDeviceFunctionEClass = null;
	 ...
	 * @see MARTE.MARTE_DesignModel.HRM.HwSpecification.HwDeviceFunction.HwDeviceFunctionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private HwDeviceFunctionPackageImpl() {
		super(eNS_URI, HwDeviceFunctionFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link HwDeviceFunctionPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static HwDeviceFunctionPackage init() {
		if (isInited) return (HwDeviceFunctionPackage)EPackage.Registry.INSTANCE.getEPackage(HwDeviceFunctionPackage.eNS_URI);

		// Obtain or create and register package
		HwDeviceFunctionPackageImpl theHwDeviceFunctionPackage = (HwDeviceFunctionPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof HwDeviceFunctionPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new HwDeviceFunctionPackageImpl());
		...
		theHwDeviceFunctionPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(HwDeviceFunctionPackage.eNS_URI, theHwDeviceFunctionPackage);
		return theHwDeviceFunctionPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getHwDeviceFunction() {
		return hwDeviceFunctionEClass;
	}
	 ...
	 * @generated
	 */
	public HwDeviceFunctionFactory getHwDeviceFunctionFactory() {
		return (HwDeviceFunctionFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		hwDeviceFunctionEClass = createEClass(HW_DEVICE_FUNCTION);
	}
	...
	public void initializePackageContents() {
		...
		hwDeviceFunctionEClass.getESuperTypes().add(theUMLPackage.getOperation());

		// Initialize classes and features; add operations and parameters
		initEClass(hwDeviceFunctionEClass, HwDeviceFunction.class, "HwDeviceFunction", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		// Create resource
		createResource(eNS_URI);
	}

} //HwDeviceFunctionPackageImpl
