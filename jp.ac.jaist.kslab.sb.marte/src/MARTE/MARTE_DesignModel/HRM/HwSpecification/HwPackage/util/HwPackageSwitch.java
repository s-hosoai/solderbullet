...
public class HwPackageSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HwPackagePackage.HW_PACKAGE: {
				HwPackage hwPackage = (HwPackage)theEObject;
				Object result = caseHwPackage(hwPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HwPackagePackage.HW_PACKAGE_PIN: {
				HwPackagePin hwPackagePin = (HwPackagePin)theEObject;
				Object result = caseHwPackagePin(hwPackagePin);
				if (result == null) result = caseHwEndPoint(hwPackagePin);
				if (result == null) result = caseHwCommunicationResource(hwPackagePin);
				if (result == null) result = caseCommunicationEndPoint(hwPackagePin);
				if (result == null) result = caseHwResource(hwPackagePin);
				if (result == null) result = caseResource(hwPackagePin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HwPackagePackage.HW_WIRE: {
				HwWire hwWire = (HwWire)theEObject;
				Object result = caseHwWire(hwWire);
				if (result == null) result = caseHwMedia(hwWire);
				if (result == null) result = caseCommunicationMedia(hwWire);
				if (result == null) result = caseHwCommunicationResource(hwWire);
				if (result == null) result = caseProcessingResource(hwWire);
				if (result == null) result = caseHwResource(hwWire);
				if (result == null) result = caseResource(hwWire);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Hw Package</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Hw Package</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Hw Wire</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Hw Wire</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
