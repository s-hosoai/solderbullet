...
import MARTE.MARTE_DesignModel.HRM.HwSpecification.HwDatasheet.HwDatasheetFactory;
 ...
 * @generated
 */
public class HwDatasheetPackageImpl extends EPackageImpl implements HwDatasheetPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass hwDatasheetEClass = null;
	 ...
	 * @see MARTE.MARTE_DesignModel.HRM.HwSpecification.HwDatasheet.HwDatasheetPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private HwDatasheetPackageImpl() {
		super(eNS_URI, HwDatasheetFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link HwDatasheetPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static HwDatasheetPackage init() {
		if (isInited) return (HwDatasheetPackage)EPackage.Registry.INSTANCE.getEPackage(HwDatasheetPackage.eNS_URI);

		// Obtain or create and register package
		HwDatasheetPackageImpl theHwDatasheetPackage = (HwDatasheetPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof HwDatasheetPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new HwDatasheetPackageImpl());
		...
		theHwDatasheetPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(HwDatasheetPackage.eNS_URI, theHwDatasheetPackage);
		return theHwDatasheetPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getHwDatasheet() {
		return hwDatasheetEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getHwDatasheet_Components() {
		return (EReference)hwDatasheetEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getHwDatasheet_Revision() {
		return (EAttribute)hwDatasheetEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getHwDatasheet_Name() {
		return (EAttribute)hwDatasheetEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getHwDatasheet_Protocols() {
		return (EReference)hwDatasheetEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public HwDatasheetFactory getHwDatasheetFactory() {
		return (HwDatasheetFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		hwDatasheetEClass = createEClass(HW_DATASHEET);
		createEReference(hwDatasheetEClass, HW_DATASHEET__COMPONENTS);
		createEAttribute(hwDatasheetEClass, HW_DATASHEET__REVISION);
		createEAttribute(hwDatasheetEClass, HW_DATASHEET__NAME);
		createEReference(hwDatasheetEClass, HW_DATASHEET__PROTOCOLS);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(hwDatasheetEClass, HwDatasheet.class, "HwDatasheet", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getHwDatasheet_Components(), theHwGeneralPackage.getHwResource(), null, "components", null, 0, -1, HwDatasheet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHwDatasheet_Revision(), theEcorePackage.getEString(), "revision", null, 0, 1, HwDatasheet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHwDatasheet_Name(), theEcorePackage.getEString(), "name", null, 0, 1, HwDatasheet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getHwDatasheet_Protocols(), theHwProtocolPackage.getHwProtocol(), null, "protocols", null, 0, -1, HwDatasheet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Create resource
		createResource(eNS_URI);
	}

} //HwDatasheetPackageImpl
