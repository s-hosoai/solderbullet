 ...
 * @generated
 */
public class HwRegisterPackageImpl extends EPackageImpl implements HwRegisterPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass hwRegisterEClass = null;
	 ...
	 * @see MARTE.MARTE_DesignModel.HRM.HwSpecification.HwRegister.HwRegisterPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private HwRegisterPackageImpl() {
		super(eNS_URI, HwRegisterFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link HwRegisterPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static HwRegisterPackage init() {
		if (isInited) return (HwRegisterPackage)EPackage.Registry.INSTANCE.getEPackage(HwRegisterPackage.eNS_URI);

		// Obtain or create and register package
		HwRegisterPackageImpl theHwRegisterPackage = (HwRegisterPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof HwRegisterPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new HwRegisterPackageImpl());
		...
		theHwRegisterPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(HwRegisterPackage.eNS_URI, theHwRegisterPackage);
		return theHwRegisterPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getHwRegister() {
		return hwRegisterEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getHwRegister_Address() {
		return (EAttribute)hwRegisterEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public HwRegisterFactory getHwRegisterFactory() {
		return (HwRegisterFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		hwRegisterEClass = createEClass(HW_REGISTER);
		createEAttribute(hwRegisterEClass, HW_REGISTER__ADDRESS);
	}
	...
	public void initializePackageContents() {
		...
		hwRegisterEClass.getESuperTypes().add(theHwMemoryPackage.getHwMemory());

		// Initialize classes and features; add operations and parameters
		initEClass(hwRegisterEClass, HwRegister.class, "HwRegister", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getHwRegister_Address(), theEcorePackage.getEString(), "address", null, 0, 1, HwRegister.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Create resource
		createResource(eNS_URI);
	}

} //HwRegisterPackageImpl
