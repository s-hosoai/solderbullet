...
public class HwRegisterSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HwRegisterPackage.HW_REGISTER: {
				HwRegister hwRegister = (HwRegister)theEObject;
				Object result = caseHwRegister(hwRegister);
				if (result == null) result = caseHwMemory(hwRegister);
				if (result == null) result = caseHwResource(hwRegister);
				if (result == null) result = caseStorageResource(hwRegister);
				if (result == null) result = caseResource(hwRegister);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Hw Register</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Hw Register</em>'.
