...
public class HwIOSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HwIOPackage.HW_PIN: {
				HwPin hwPin = (HwPin)theEObject;
				Object result = caseHwPin(hwPin);
				if (result == null) result = caseHwEndPoint(hwPin);
				if (result == null) result = caseHwCommunicationResource(hwPin);
				if (result == null) result = caseCommunicationEndPoint(hwPin);
				if (result == null) result = caseHwResource(hwPin);
				if (result == null) result = caseResource(hwPin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HwIOPackage.HW_LINE: {
				HwLine hwLine = (HwLine)theEObject;
				Object result = caseHwLine(hwLine);
				if (result == null) result = caseHwMedia(hwLine);
				if (result == null) result = caseCommunicationMedia(hwLine);
				if (result == null) result = caseHwCommunicationResource(hwLine);
				if (result == null) result = caseProcessingResource(hwLine);
				if (result == null) result = caseHwResource(hwLine);
				if (result == null) result = caseResource(hwLine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Hw Pin</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Hw Pin</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Hw Line</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Hw Line</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
