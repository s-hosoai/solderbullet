...
public class HwPowerPackageImpl extends EPackageImpl implements HwPowerPackage {
	 ...
	 * @see MARTE.MARTE_DesignModel.HRM.HwPhysical.HwPower.HwPowerPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getHwPowerSupply_SuppliedPower() {
		return (EReference)hwPowerSupplyEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getHwPowerSupply_Capacity() {
		return (EReference)hwPowerSupplyEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getHwCoolingSupply_CoolingPower() {
		return (EReference)hwCoolingSupplyEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(hwPowerSupplyEClass, HW_POWER_SUPPLY__SUPPLIED_POWER);
		createEReference(hwPowerSupplyEClass, HW_POWER_SUPPLY__CAPACITY);

		hwCoolingSupplyEClass = createEClass(HW_COOLING_SUPPLY);
		createEReference(hwCoolingSupplyEClass, HW_COOLING_SUPPLY__COOLING_POWER);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getHwPowerSupply_SuppliedPower(), theBasicNFP_TypesPackage.getNFP_Power(), null, "suppliedPower", null, 0, 1, HwPowerSupply.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwPowerSupply_Capacity(), theBasicNFP_TypesPackage.getNFP_Energy(), null, "capacity", null, 0, 1, HwPowerSupply.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getHwCoolingSupply_CoolingPower(), theBasicNFP_TypesPackage.getNFP_Power(), null, "coolingPower", null, 0, 1, HwCoolingSupply.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
