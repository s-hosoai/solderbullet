...
public class HwLayoutPackageImpl extends EPackageImpl implements HwLayoutPackage {
	 ...
	 * @generated
	 */
	private EClass env_ConditionEClass = null;
	 ...
	 * @see MARTE.MARTE_DesignModel.HRM.HwPhysical.HwLayout.HwLayoutPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getHwComponent_Dimensions() {
	 ...
	 * @generated
	 */
	public EReference getHwComponent_Area() {
		return (EReference)hwComponentEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getHwComponent_Position() {
		return (EReference)hwComponentEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getHwComponent_Grid() {
		return (EReference)hwComponentEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getHwComponent_NbPins() {
		return (EReference)hwComponentEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getHwComponent_Weight() {
		return (EReference)hwComponentEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EReference getHwComponent_Price() {
		return (EReference)hwComponentEClass.getEStructuralFeatures().get(7);
	}
	 ...
	 * @generated
	 */
	public EReference getHwComponent_R_Conditions() {
		return (EReference)hwComponentEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 * @generated
	 */
	public EReference getHwComponent_StaticConsumption() {
		return (EReference)hwComponentEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 * @generated
	 */
	public EReference getHwComponent_StaticDissipation() {
		return (EReference)hwComponentEClass.getEStructuralFeatures().get(11);
	}
	 ...
	 * @generated
	 */
	public EClass getEnv_Condition() {
		return env_ConditionEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getEnv_Condition_Type() {
		return (EAttribute)env_ConditionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getEnv_Condition_Status() {
		return (EAttribute)env_ConditionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getEnv_Condition_Description() {
		return (EReference)env_ConditionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getEnv_Condition_Range() {
		return (EReference)env_ConditionEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(hwComponentEClass, HW_COMPONENT__DIMENSIONS);
		createEReference(hwComponentEClass, HW_COMPONENT__AREA);
		createEReference(hwComponentEClass, HW_COMPONENT__POSITION);
		createEReference(hwComponentEClass, HW_COMPONENT__GRID);
		createEReference(hwComponentEClass, HW_COMPONENT__NB_PINS);
		createEReference(hwComponentEClass, HW_COMPONENT__WEIGHT);
		createEReference(hwComponentEClass, HW_COMPONENT__PRICE);
		createEReference(hwComponentEClass, HW_COMPONENT__RCONDITIONS);
		createEReference(hwComponentEClass, HW_COMPONENT__POWERED_SERVICES);
		createEReference(hwComponentEClass, HW_COMPONENT__STATIC_CONSUMPTION);
		createEReference(hwComponentEClass, HW_COMPONENT__STATIC_DISSIPATION);
		createEReference(hwComponentEClass, HW_COMPONENT__SUB_COMPONENTS);

		env_ConditionEClass = createEClass(ENV_CONDITION);
		createEAttribute(env_ConditionEClass, ENV_CONDITION__TYPE);
		createEAttribute(env_ConditionEClass, ENV_CONDITION__STATUS);
		createEReference(env_ConditionEClass, ENV_CONDITION__DESCRIPTION);
		createEReference(env_ConditionEClass, ENV_CONDITION__RANGE);
	...
	public void initializePackageContents() {
		...
		initEReference(getHwComponent_Dimensions(), theBasicNFP_TypesPackage.getNFP_Length(), null, "dimensions", null, 0, 3, HwComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwComponent_Area(), theBasicNFP_TypesPackage.getNFP_Area(), null, "area", null, 0, 1, HwComponent.class, !IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, IS_DERIVED, !IS_ORDERED);
		initEReference(getHwComponent_Position(), theMARTE_DataTypesPackage.getNFP_NaturalInterval(), null, "position", null, 0, 2, HwComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwComponent_Grid(), theBasicNFP_TypesPackage.getNFP_Natural(), null, "grid", null, 0, 2, HwComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwComponent_NbPins(), theBasicNFP_TypesPackage.getNFP_Natural(), null, "nbPins", null, 0, 1, HwComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwComponent_Weight(), theBasicNFP_TypesPackage.getNFP_Real(), null, "weight", null, 0, 1, HwComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwComponent_Price(), theBasicNFP_TypesPackage.getNFP_Price(), null, "price", null, 0, 1, HwComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwComponent_R_Conditions(), this.getEnv_Condition(), null, "r_Conditions", null, 0, -1, HwComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getHwComponent_StaticConsumption(), theBasicNFP_TypesPackage.getNFP_Power(), null, "staticConsumption", null, 0, 1, HwComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getHwComponent_StaticDissipation(), theBasicNFP_TypesPackage.getNFP_Power(), null, "staticDissipation", null, 0, 1, HwComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(env_ConditionEClass, Env_Condition.class, "Env_Condition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEnv_Condition_Type(), this.getConditionType(), "type", null, 0, 1, Env_Condition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getEnv_Condition_Status(), this.getComponentState(), "status", null, 0, 1, Env_Condition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getEnv_Condition_Description(), theBasicNFP_TypesPackage.getNFP_String(), null, "description", null, 0, 1, Env_Condition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getEnv_Condition_Range(), theMARTE_DataTypesPackage.getRealnterval(), null, "range", null, 0, 1, Env_Condition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

		// Initialize enums and add enum literals
		initEEnum(componentKindEEnum, ComponentKind.class, "ComponentKind");
		addEEnumLiteral(componentKindEEnum, ComponentKind.CARD_LITERAL);
		addEEnumLiteral(componentKindEEnum, ComponentKind.CHANNEL_LITERAL);
		addEEnumLiteral(componentKindEEnum, ComponentKind.CHIP_LITERAL);
		addEEnumLiteral(componentKindEEnum, ComponentKind.PORT_LITERAL);
		addEEnumLiteral(componentKindEEnum, ComponentKind.UNIT_LITERAL);
		addEEnumLiteral(componentKindEEnum, ComponentKind.OTHER_LITERAL);
		addEEnumLiteral(componentKindEEnum, ComponentKind.UNDEF_LITERAL);

		initEEnum(conditionTypeEEnum, ConditionType.class, "ConditionType");
		addEEnumLiteral(conditionTypeEEnum, ConditionType.TEMPERATURE_LITERAL);
		addEEnumLiteral(conditionTypeEEnum, ConditionType.HUMIDITY_LITERAL);
		addEEnumLiteral(conditionTypeEEnum, ConditionType.ALTITUDE_LITERAL);
		addEEnumLiteral(conditionTypeEEnum, ConditionType.VIBRATION_LITERAL);
		addEEnumLiteral(conditionTypeEEnum, ConditionType.SHOCK_LITERAL);
		addEEnumLiteral(conditionTypeEEnum, ConditionType.OTHER_LITERAL);
		addEEnumLiteral(conditionTypeEEnum, ConditionType.UNDEF_LITERAL);

		initEEnum(componentStateEEnum, ComponentState.class, "ComponentState");
		addEEnumLiteral(componentStateEEnum, ComponentState.OPERATING_LITERAL);
		addEEnumLiteral(componentStateEEnum, ComponentState.STORAGE_LITERAL);
		addEEnumLiteral(componentStateEEnum, ComponentState.OTHER_LITERAL);
		addEEnumLiteral(componentStateEEnum, ComponentState.UNDEF_LITERAL);
