...
import MARTE.MARTE_DesignModel.SRM.SW_Concurrency.SW_ConcurrencyFactory;
...
public class SW_ConcurrencyPackageImpl extends EPackageImpl implements SW_ConcurrencyPackage {
	 ...
	 * @see MARTE.MARTE_DesignModel.SRM.SW_Concurrency.SW_ConcurrencyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getSwConcurrentResource_Type() {
		return (EReference)swConcurrentResourceEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(swConcurrentResourceEClass, SW_CONCURRENT_RESOURCE__TYPE);
	...
	public void initializePackageContents() {
		...
		initEReference(getSwConcurrentResource_Type(), theBasicNFP_TypesPackage.getArrivalPattern(), null, "type", null, 0, 1, SwConcurrentResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		addEEnumLiteral(interruptKindEEnum, InterruptKind.HARDWARE_INTERRUPTION_LITERAL);
		addEEnumLiteral(interruptKindEEnum, InterruptKind.PROCESSOR_DETECTED_EXCEPTION_LITERAL);
		addEEnumLiteral(interruptKindEEnum, InterruptKind.PROGRAMMED_EXCEPTION_LITERAL);
		addEEnumLiteral(interruptKindEEnum, InterruptKind.UNDEF_LITERAL);
		addEEnumLiteral(interruptKindEEnum, InterruptKind.OTHER_LITERAL);
