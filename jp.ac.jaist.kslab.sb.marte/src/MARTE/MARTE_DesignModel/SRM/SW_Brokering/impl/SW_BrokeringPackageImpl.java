...
public class SW_BrokeringPackageImpl extends EPackageImpl implements SW_BrokeringPackage {
	 ...
	 * @see MARTE.MARTE_DesignModel.SRM.SW_Brokering.SW_BrokeringPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getDeviceBroker_Operations() {
		return (EReference)deviceBrokerEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 * @generated
	 */
	public EReference getDeviceBroker_Activities() {
		return (EReference)deviceBrokerEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 * @generated
	 */
	public EAttribute getDeviceBroker_Name() {
		return (EAttribute)deviceBrokerEClass.getEStructuralFeatures().get(10);
	}
	...
	public void createPackageContents() {
		...
		createEReference(deviceBrokerEClass, DEVICE_BROKER__OPERATIONS);
		createEReference(deviceBrokerEClass, DEVICE_BROKER__ACTIVITIES);
		createEAttribute(deviceBrokerEClass, DEVICE_BROKER__NAME);
	...
	public void initializePackageContents() {
		...
		initEReference(getDeviceBroker_Operations(), theUMLPackage.getOperation(), null, "operations", null, 0, -1, DeviceBroker.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDeviceBroker_Activities(), theUMLPackage.getActivity(), null, "activities", null, 0, -1, DeviceBroker.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDeviceBroker_Name(), theEcorePackage.getEString(), "name", null, 0, 1, DeviceBroker.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(accessPolicyKindEEnum, AccessPolicyKind.READ_LITERAL);
		addEEnumLiteral(accessPolicyKindEEnum, AccessPolicyKind.WRITE_LITERAL);
		addEEnumLiteral(accessPolicyKindEEnum, AccessPolicyKind.READ_WRITE_LITERAL);
		addEEnumLiteral(accessPolicyKindEEnum, AccessPolicyKind.UNDEF_LITERAL);
		addEEnumLiteral(accessPolicyKindEEnum, AccessPolicyKind.OTHER_LITERAL);
