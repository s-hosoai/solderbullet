 ...
 * <!-- end-user-doc -->
 * @see MARTE.MARTE_DesignModel.GCM.GCMPackage#getFlowDirectionKind()
 * @model
 * @generated
 */
public final class FlowDirectionKind extends AbstractEnumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final FlowDirectionKind IN_LITERAL = new FlowDirectionKind(IN, "in", "in");
	 ...
	 * @ordered
	 */
	public static final FlowDirectionKind OUT_LITERAL = new FlowDirectionKind(OUT, "out", "out");
	 ...
	 * @ordered
	 */
	public static final FlowDirectionKind INOUT_LITERAL = new FlowDirectionKind(INOUT, "inout", "inout");
