 ...
 * </p>
 * <ul>
 *   <li>{@link MARTE.MARTE_DesignModel.HLAM.impl.RtFeatureImpl#getBase_BehavioralFeature <em>Base Behavioral Feature</em>}</li>
 *   <li>{@link MARTE.MARTE_DesignModel.HLAM.impl.RtFeatureImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link MARTE.MARTE_DesignModel.HLAM.impl.RtFeatureImpl#getBase_Signal <em>Base Signal</em>}</li>
 *   <li>{@link MARTE.MARTE_DesignModel.HLAM.impl.RtFeatureImpl#getBase_Port <em>Base Port</em>}</li>
 *   <li>{@link MARTE.MARTE_DesignModel.HLAM.impl.RtFeatureImpl#getBase_InvocationAction <em>Base Invocation Action</em>}</li>
 *   <li>{@link MARTE.MARTE_DesignModel.HLAM.impl.RtFeatureImpl#getSpecification <em>Specification</em>}</li>
 * </ul>
 *
 * @generated
 */
