 ...
 * </p>
 * <ul>
 *   <li>{@link MARTE.MARTE_Annexes.VSL.DataTypes.impl.BoundedSubtypeImpl#getBaseType <em>Base Type</em>}</li>
 *   <li>{@link MARTE.MARTE_Annexes.VSL.DataTypes.impl.BoundedSubtypeImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link MARTE.MARTE_Annexes.VSL.DataTypes.impl.BoundedSubtypeImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link MARTE.MARTE_Annexes.VSL.DataTypes.impl.BoundedSubtypeImpl#isIsMinOpen <em>Is Min Open</em>}</li>
 *   <li>{@link MARTE.MARTE_Annexes.VSL.DataTypes.impl.BoundedSubtypeImpl#isIsMaxOpen <em>Is Max Open</em>}</li>
 *   <li>{@link MARTE.MARTE_Annexes.VSL.DataTypes.impl.BoundedSubtypeImpl#getBase_DataType <em>Base Data Type</em>}</li>
 * </ul>
 *
 * @generated
 */
