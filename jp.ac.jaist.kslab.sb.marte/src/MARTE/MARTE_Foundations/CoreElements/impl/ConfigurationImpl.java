 ...
 * </p>
 * <ul>
 *   <li>{@link MARTE.MARTE_Foundations.CoreElements.impl.ConfigurationImpl#getBase_StructuredClassifier <em>Base Structured Classifier</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.CoreElements.impl.ConfigurationImpl#getBase_Package <em>Base Package</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.CoreElements.impl.ConfigurationImpl#getMode <em>Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigurationImpl extends EObjectImpl implements Configuration {
	...
	public EList getMode() {
		if (mode == null) {
			mode = new EObjectResolvingEList(Mode.class, this, CoreElementsPackage.CONFIGURATION__MODE);
		}
		return mode;
	}
