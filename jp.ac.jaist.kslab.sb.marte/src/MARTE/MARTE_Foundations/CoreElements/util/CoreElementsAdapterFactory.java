...
public class CoreElementsAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected CoreElementsSwitch modelSwitch =
		new CoreElementsSwitch() {
			public Object caseModeTransition(ModeTransition object) {
				return createModeTransitionAdapter();
			}
			public Object caseModeBehavior(ModeBehavior object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link MARTE.MARTE_Foundations.CoreElements.ModeTransition <em>Mode Transition</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link MARTE.MARTE_Foundations.CoreElements.ModeBehavior <em>Mode Behavior</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link MARTE.MARTE_Foundations.CoreElements.Mode <em>Mode</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
