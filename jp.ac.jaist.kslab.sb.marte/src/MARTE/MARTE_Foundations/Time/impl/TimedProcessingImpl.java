 ...
 * </p>
 * <ul>
 *   <li>{@link MARTE.MARTE_Foundations.Time.impl.TimedProcessingImpl#getBase_Action <em>Base Action</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.Time.impl.TimedProcessingImpl#getBase_Behavior <em>Base Behavior</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.Time.impl.TimedProcessingImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.Time.impl.TimedProcessingImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.Time.impl.TimedProcessingImpl#getStart <em>Start</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.Time.impl.TimedProcessingImpl#getFinish <em>Finish</em>}</li>
 * </ul>
 *
 * @generated
 */
