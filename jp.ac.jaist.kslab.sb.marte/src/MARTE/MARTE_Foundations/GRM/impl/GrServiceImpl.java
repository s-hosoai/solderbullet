 ...
 * </p>
 * <ul>
 *   <li>{@link MARTE.MARTE_Foundations.GRM.impl.GrServiceImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.GRM.impl.GrServiceImpl#getBase_ExecutionSpecification <em>Base Execution Specification</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.GRM.impl.GrServiceImpl#getBase_BehavioralFeature <em>Base Behavioral Feature</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.GRM.impl.GrServiceImpl#getBase_Behavior <em>Base Behavior</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.GRM.impl.GrServiceImpl#getBase_Collaboration <em>Base Collaboration</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.GRM.impl.GrServiceImpl#getBase_CollaborationUse <em>Base Collaboration Use</em>}</li>
 * </ul>
 *
 * @generated
 */
