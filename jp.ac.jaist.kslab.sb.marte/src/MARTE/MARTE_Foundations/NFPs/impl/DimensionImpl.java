 ...
 * </p>
 * <ul>
 *   <li>{@link MARTE.MARTE_Foundations.NFPs.impl.DimensionImpl#getSymbol <em>Symbol</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.NFPs.impl.DimensionImpl#getBaseDimension <em>Base Dimension</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.NFPs.impl.DimensionImpl#getBaseExponent <em>Base Exponent</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.NFPs.impl.DimensionImpl#getBase_Enumeration <em>Base Enumeration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DimensionImpl extends EObjectImpl implements Dimension {
	 ...
	 * @generated
	 */
	public EList getBaseDimension() {
		if (baseDimension == null) {
			baseDimension = new EObjectResolvingEList(Dimension.class, this, NFPsPackage.DIMENSION__BASE_DIMENSION);
		}
	 ...
	 * @generated
	 */
	public EList getBaseExponent() {
		if (baseExponent == null) {
			baseExponent = new EDataTypeEList(Integer.class, this, NFPsPackage.DIMENSION__BASE_EXPONENT);
		}
		return baseExponent;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case NFPsPackage.DIMENSION__BASE_DIMENSION:
				...
				getBaseDimension().addAll((Collection)newValue);
				return;
			case NFPsPackage.DIMENSION__BASE_EXPONENT:
				getBaseExponent().clear();
				getBaseExponent().addAll((Collection)newValue);
				return;
			case NFPsPackage.DIMENSION__BASE_ENUMERATION:
