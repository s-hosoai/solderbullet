...
import MARTE.MARTE_Foundations.Alloc.AllocFactory;
...
import MARTE.MARTE_Foundations.Alloc.AllocationEndKind;
...
import MARTE.MARTE_Foundations.Alloc.AssignmentKind;
import MARTE.MARTE_Foundations.Alloc.AssignmentNature;
...
public class AllocPackageImpl extends EPackageImpl implements AllocPackage {
	 ...
	 * @see MARTE.MARTE_Foundations.Alloc.AllocPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EReference getAllocateActivityGroup_Base_ActivityPartition() {
		return (EReference)allocateActivityGroupEClass.getEStructuralFeatures().get(0);
	}
	...
	public void initializePackageContents() {
		...
		addEEnumLiteral(allocationNatureEEnum, AllocationNature.SPATIAL_DISTRIBUTION_LITERAL);
		addEEnumLiteral(allocationNatureEEnum, AllocationNature.TIME_SCHEDULING_LITERAL);
		...
		addEEnumLiteral(assignmentKindEEnum, AssignmentKind.STRUCTURAL_LITERAL);
		addEEnumLiteral(assignmentKindEEnum, AssignmentKind.BEHAVIORAL_LITERAL);
		addEEnumLiteral(assignmentKindEEnum, AssignmentKind.HYBRID_LITERAL);
