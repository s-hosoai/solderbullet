...
import MARTE.MARTE_Foundations.Alloc.AllocationNature;
 ...
 * </p>
 * <ul>
 *   <li>{@link MARTE.MARTE_Foundations.Alloc.impl.AllocateImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.Alloc.impl.AllocateImpl#getNature <em>Nature</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.Alloc.impl.AllocateImpl#getBase_Abstraction <em>Base Abstraction</em>}</li>
 *   <li>{@link MARTE.MARTE_Foundations.Alloc.impl.AllocateImpl#getImpliedConstraint <em>Implied Constraint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AllocateImpl extends EObjectImpl implements Allocate {
	 ...
	 * @ordered
	 */
	protected static final AllocationKind KIND_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected static final AllocationNature NATURE_EDEFAULT = AllocationNature.SPATIAL_DISTRIBUTION_LITERAL;
	...
	public EList getImpliedConstraint() {
		if (impliedConstraint == null) {
			impliedConstraint = new EObjectResolvingEList(NfpConstraint.class, this, AllocPackage.ALLOCATE__IMPLIED_CONSTRAINT);
		}
