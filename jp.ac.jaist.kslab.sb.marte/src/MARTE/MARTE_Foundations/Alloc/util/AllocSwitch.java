	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AllocPackage.ALLOCATED: {
				...
				Object result = caseAllocated(allocated);
			...
			case AllocPackage.ALLOCATE_ACTIVITY_GROUP: {
				...
				Object result = caseAllocateActivityGroup(allocateActivityGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AllocPackage.NFP_REFINE: {
				NfpRefine nfpRefine = (NfpRefine)theEObject;
				Object result = caseNfpRefine(nfpRefine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
