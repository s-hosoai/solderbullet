...
import MARTE.blockdiagram.part.MARTE_sbDiagramUpdater;
import MARTE.blockdiagram.part.MARTE_sbLinkDescriptor;
import MARTE.blockdiagram.part.MARTE_sbNodeDescriptor;
import MARTE.blockdiagram.part.MARTE_sbVisualIDRegistry;

/**
 * @generated
 */
public class HwBlockDiagramCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List/*[MARTE.blockdiagram.part.MARTE_sbNodeDescriptor]*/childDescriptors = MARTE_sbDiagramUpdater
				.getHwBlockDiagram_1000SemanticChildren(viewObject);
		for (Iterator/*[MARTE.blockdiagram.part.MARTE_sbNodeDescriptor]*/it = childDescriptors
				.iterator(); it.hasNext();) {
			MARTE_sbNodeDescriptor d = (MARTE_sbNodeDescriptor) it.next();
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = MARTE_sbVisualIDRegistry.getVisualID(view);
		return visualID == HwMCUEditPart.VISUAL_ID
				|| visualID == HwDeviceEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List/*[MARTE.blockdiagram.part.MARTE_sbNodeDescriptor]*/childDescriptors = MARTE_sbDiagramUpdater
				.getHwBlockDiagram_1000SemanticChildren((View) getHost()
						.getModel());
		...
		for (Iterator/*[MARTE.blockdiagram.part.MARTE_sbNodeDescriptor]*/descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			MARTE_sbNodeDescriptor next = (MARTE_sbNodeDescriptor) descriptorsIterator
					.next();
			String hint = MARTE_sbVisualIDRegistry.getType(next.getVisualID());
		...
		for (Iterator/*[MARTE.blockdiagram.part.MARTE_sbNodeDescriptor]*/it = childDescriptors
				.iterator(); it.hasNext();) {
			MARTE_sbNodeDescriptor next = (MARTE_sbNodeDescriptor) it.next();
			String hint = MARTE_sbVisualIDRegistry.getType(next.getVisualID());
	...
	private Collection/*[org.eclipse.core.runtime.IAdaptable]*/refreshConnections() {
		...
		Collection/*[MARTE.blockdiagram.part.MARTE_sbLinkDescriptor]*/linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = MARTE_sbVisualIDRegistry
			...
			for (Iterator/*[MARTE.blockdiagram.part.MARTE_sbLinkDescriptor]*/linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				MARTE_sbLinkDescriptor nextLinkDescriptor = (MARTE_sbLinkDescriptor) linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection/*[MARTE.blockdiagram.part.MARTE_sbLinkDescriptor]*/collectAllLinks(
			View view,
			Map/*[org.eclipse.emf.ecore.EObject, org.eclipse.gmf.runtime.notation.View]*/domain2NotationMap) {
		if (!HwBlockDiagramEditPart.MODEL_ID.equals(MARTE_sbVisualIDRegistry
				.getModelID(view))) {
		...
		case HwBlockDiagramEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(MARTE_sbDiagramUpdater
						.getHwBlockDiagram_1000ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
		...
		case HwMCUEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(MARTE_sbDiagramUpdater
						.getHwMCU_2001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case HwDeviceEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(MARTE_sbDiagramUpdater
						.getHwDevice_2002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case HwConnectionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(MARTE_sbDiagramUpdater
						.getHwConnection_4001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
	...
	private Collection/*[org.eclipse.core.runtime.IAdaptable]*/createConnections(
			Collection/*[MARTE.blockdiagram.part.MARTE_sbLinkDescriptor]*/linkDescriptors,
			Map/*[org.eclipse.emf.ecore.EObject, org.eclipse.gmf.runtime.notation.View]*/domain2NotationMap) {
		LinkedList/*[org.eclipse.core.runtime.IAdaptable]*/adapters = new LinkedList/*[org.eclipse.core.runtime.IAdaptable]*/();
		for (Iterator/*[MARTE.blockdiagram.part.MARTE_sbLinkDescriptor]*/it = linkDescriptors
				.iterator(); it.hasNext();) {
			MARTE_sbLinkDescriptor nextLinkDescriptor = (MARTE_sbLinkDescriptor) it
					.next();
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(
					...
					MARTE_sbVisualIDRegistry.getType(nextLinkDescriptor
