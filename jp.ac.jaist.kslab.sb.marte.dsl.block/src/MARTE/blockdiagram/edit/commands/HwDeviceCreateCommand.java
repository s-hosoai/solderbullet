 ...
 * @generated
 */
public class HwDeviceCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public HwDeviceCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		HwDevice newElement = HwDeviceFactory.eINSTANCE
				.createHwDevice();

		HwBlockDiagram owner = (HwBlockDiagram) getElementToEdit();
