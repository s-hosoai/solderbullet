 ...
 * @generated
 */
public class MARTE_sbDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public MARTE_sbDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof MARTE_sbDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((MARTE_sbDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new MARTE_sbDomainNavigatorItem(
