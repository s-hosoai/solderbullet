...
import MARTE.blockdiagram.part.MARTE_sbDiagramEditor;
 ...
 * @generated
 */
public class MARTE_sbNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof MARTE_sbNavigatorItem) {
					selectedElement = ((MARTE_sbNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (HwBlockDiagramEditPart.MODEL_ID
							.equals(MARTE_sbVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, MARTE_sbDiagramEditor.ID);
