 ...
 * @generated
 */
public class BlockdiagramSwitch {
	/**
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BlockdiagramPackage.DIAGRAM: {
				Diagram diagram = (Diagram)theEObject;
				Object result = caseDiagram(diagram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BlockdiagramPackage.HW_COMPONENT: {
				HwComponent hwComponent = (HwComponent)theEObject;
				Object result = caseHwComponent(hwComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case BlockdiagramPackage.MCU: {
				MCU mcu = (MCU)theEObject;
				Object result = caseMCU(mcu);
				if (result == null) result = caseHwComponent(mcu);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BlockdiagramPackage.DEVICE: {
				Device device = (Device)theEObject;
				Object result = caseDevice(device);
				if (result == null) result = caseHwComponent(device);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>MCU</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>MCU</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
